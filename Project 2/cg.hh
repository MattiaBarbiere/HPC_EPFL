...
public:
  ...
  virtual void solve(std::vector<double> & x, int threads_per_block, int blocks_per_grid) = 0;
...
public:
  ...
  virtual void solve(std::vector<double> & x, int threads_per_block, int blocks_per_grid);
